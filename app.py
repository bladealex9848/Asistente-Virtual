...
APP_IDENTITY = {
    ...
    "version": "1.0.0",
    "icon": "🤖",
    "tagline": "Tu compañero digital multiexperto",
    "full_title": "Bienvenido a tu Asistente Virtual 🤖",
    
    # Información del desarrollador
    "developer": "Alexander Oviedo Fadul",
    "github_url": "https://github.com/bladealex9848",
    "website_url": "https://alexanderoviedofadul.dev/",
    "docs_url": "https://github.com/bladealex9848/Asistente-Virtual/blob/main/README.md",
    ...
    "repository_url": "https://github.com/bladealex9848/Asistente-Virtual",
    
    # Descripción de la aplicación - formas corta y larga
    "short_description": "Tu compañero digital multiexperto, siempre listo para ayudarte en español.",
    "long_description": """
    ...
    **No dudes en preguntarme sobre cualquier tema. ¡Estoy aquí para ayudarte en español!**
    ...
    # User instructions
    "usage_instructions": """
    1. **Consultas generales**: Escribe tu pregunta en el chat para recibir información sobre cualquier tema.

    2. **Solicitud de asistencia**: Puedes pedir ayuda con tareas específicas como análisis, cálculos o planificación.

    3. **Elaboración de contenido**: Solicita la creación de textos, resúmenes o documentos sobre diversos temas.

    4. **Resolución de problemas**: Describe un problema o situación y pide sugerencias para resolverlo.

    5. **Aprendizaje**: Solicita explicaciones detalladas y ejemplos sobre temas que desees comprender mejor.
    """,
    ...
    - Extraer texto de documentos en diversos formatos
    - Analizar el contenido de documentos y proporcionar resúmenes
    - Identificar información relevante para tus consultas
    - Facilitar el análisis de documentos extensos o complejos
    ...
    **Nota sobre privacidad**: Los documentos se procesan localmente y no se almacenan permanentemente.
    ...
    "file_upload_default_message": "He cargado el documento '{files}' para análisis. Por favor, indícame qué información necesitas extraer o analizar de este documento.",
    "badges": """
    ![Visitantes](https://api.visitorbadge.io/api/visitors?path=https%3A%2F%2Fasistentevirtual.streamlit.app&label=Visitantes&labelColor=%235d5d5d&countColor=%231e7ebf&style=flat)
    """,
    ...
    Soy tu compañero digital multiexperto, siempre listo para ayudarte en español con respuestas precisas, claras y personalizadas.

    * Puedo responder preguntas sobre una amplia variedad de temas
    * Asistirte en tareas como análisis, cálculos o planificación
    * Proporcionar explicaciones detalladas y ejemplos prácticos
    * Ofrecer sugerencias y soluciones creativas a tus problemas
    * Y mucho más...
    ...
    **¿En qué puedo ayudarte hoy?**
    ...
    # Log configuration
    "log_name": "asistentevirtual",
    
    # Document naming (for exports and files)
    "document_prefix": "asistentevirtual",
    "conversation_export_name": "asistentevirtual_conversacion",
}
